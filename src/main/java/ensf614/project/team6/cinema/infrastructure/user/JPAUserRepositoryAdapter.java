...
public class JPAUserRepositoryAdapter implements UserRepository {
    ...
    private final static List<String> DEFAULT_NAMES = Arrays.asList("admin@ensf614.ca");
    private final static List<String> DEFAULT_EMAILS = Arrays.asList("admin@ensf614.ca");
    private final static List<String> DEFAULT_PASSWORDS = Arrays.asList("admin@ensf614.ca");

    private final static List<Set<String>> DEFAULT_ROLES = new ArrayList<>() {{
        add(new HashSet<>(Arrays.asList("ROLE_ADMIN")));
    }};
